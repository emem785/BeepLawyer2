...
//         title: new Text('New beep Alert!', style: nunitoMidBold,textAlign: TextAlign.center,),
//         content: Container(
//           height: 70,
//           child: Column(
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               Text('Got a beeep alert from  ${message["data"]["firstname"]}', style: nunitoMid),
//               Text('${distance.round()} meters away ', style: nunitoMid),
//             ],
//           ),
//         ),
//         actions: <Widget>[
